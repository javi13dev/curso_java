	...
	private void initComponents() {
		...
		FocusListener listener1 = new FocusListener() {
			...
			public void focusGained(FocusEvent e) {
				// Cuando la caja pierda el foco,
				// comprueba si el valor introducido es no numérico
				// en cuyo caso debe mantener el foco en la caja.
				JTextField jtf = (JTextField) e.getSource(); // obtiene una referencia a la caja en la que se ha producido el evento.
		...
		// Ahora hay que asociarlo a ambas cajas:
