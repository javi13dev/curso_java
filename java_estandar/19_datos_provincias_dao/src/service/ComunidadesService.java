...
public interface ComunidadesService {
	...
	// comunidades que ya estén en la base de datos 
	...
	// provincias que ya estén en la base de datos 
	// Devuelve el total de provincias guardadas.
	int saveProvincias(List<Provincia> provincias);
	// salva la lista de municipios, evitando guardar por segunda vez
	// municipios que ya estén en la base de datos 
	// Devuelve el total de municipios guardadas.
